...
<body id="page-top">
	...
	<nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top"
		id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll" href="#page-top">WELCOME</a>
			...
			<div class="navbar-collapse collapse justify-content-end"
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link js-scroll"
						href="view/admin.jsp">Admin Login</a></li>
					<!-- <li class="nav-item">
            <a class="nav-link js-scroll" href="#work">Work</a>
					...
					<li class="nav-item"><a class="nav-link js-scroll"
						href="view/login.jsp">Login</a></li>
		...
		<div class="intro-content display-table">
			<div class="table-cell">
				<div class="container">
					...
					<h1 class="intro-title mb-4">Loan Application</h1>
					<p class="intro-subtitle">
						<span class="text-slider-items"> </span><strong
							...
							<div class="col-md-6">
								<div class="row">
									<div class="col-sm-6 col-md-5">
										<div class="about-img">
											<img src="img/bank.jpg" class="img-fluid rounded b-shadow-a"
												alt="">
										</div>
									</div>
									<div class="col-sm-6 col-md-7">
										<div class="about-info">
											<p>
												<span class="title-s"> </span> <span></span>
											</p>
											<p>
												<span class="title-s"> </span> <span></span>
											</p>
								...
								<div class="skill-mf">
									<p class="title-s">Bank</p>
									<span>SBI BANK</span> <span class="pull-right">8.5%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar"
											style="width: 85%;" aria-valuenow="85" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
									<span>HDFC BANK</span> <span class="pull-right">7.5%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar"
											style="width: 75%" aria-valuenow="75" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
									<span>ICICI BANK</span> <span class="pull-right">9.5%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar"
											style="width: 50%" aria-valuenow="40" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
									<span>BAJAJ ALLIANZ</span> <span class="pull-right">8.0%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar"
											style="width: 90%" aria-valuenow="50" aria-valuemin="0"
											aria-valuemax="100"></div>
									</div>
									<span>KOTAK MAHINDRA BANK </span> <span class="pull-right">7.0%</span>
									<div class="progress">
										<div class="progress-bar" role="progressbar"
							...
							<div class="col-md-6">
								<div class="about-me pt-4 pt-md-0">
									<div class="title-box-2">
										<h5 class="title-left">About Our Application</h5>
									</div>
									<p class="lead">We are Providing Personal Loan as well as
										Bike Loan,Home Loan,Car Loan Based On User Requirements.</p>
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="more-info">
										...
										<ul class="list-ico">
											<li><span class="ion-ios-location"></span>Pune</li>
											<li><span class="ion-ios-telephone"></span>56362563</li>
											<li><span class="ion-email"></span>Infoloan@gmail.com</li>
										</ul>
									</div>
									<div class="socials">
										<ul>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="copyright-box">
							<p class="copyright">
								&copy; Copyright <strong>Welcome</strong>. All Rights Reserved
							</p>
							<div class="credits">
