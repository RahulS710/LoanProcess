...
<div class="col" style="width: 100px;height: 25px;background-color: blue;float: right;text-align: center;margin-right: 50px ">
	<a href="/view/login.jsp" style="color: white;text-align: center;">Login</a>
</div>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-12 col-md-8 col-lg-8 col-xl-6">
					...
					<div class="row align-items-center">
						<div class="col mt-4">
							<input type="text" class="form-control" placeholder="Contact No" name="contactno" required="required">
						</div>
					</div>
				
					<div class="row align-items-center">
						<div class="col mt-4">
							<input type="text" class="form-control" placeholder="Pan No" name="panno" required="required">
						</div>
					</div>
					<div class="row align-items-center">
						<div class="col mt-4">
							<input type="text" class="form-control" placeholder="Aadhar No" name="aadharno" required="required">
						</div>
					</div>
